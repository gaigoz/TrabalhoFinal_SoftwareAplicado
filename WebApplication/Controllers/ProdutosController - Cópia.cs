...
namespace WebShop.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "CategoriaId", "Tipo");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "CategoriaId", "Tipo", produto.CategoriaId);
            return View(produto);
        }
